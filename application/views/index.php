...
<head>
	...
	<link href="<?= base_url('assets/'); ?>css/media_query.css" rel="stylesheet" type="text/css" />
		...
		<div class="container animate-box">
			<div class="row">
				...
				<div class="col-12 col-md-5 col-lg-3 position_footer_relative">
					...
					<div class="footer_makes_sub_font"> Dec 31, 2016</div>
					<a href="#" class="footer_post pb-4"> Success is not a good teacher failure makes you humble </a>
					<div class="footer_position_absolute"><img src="<?= base_url('assets/'); ?>images/footer_sub_tipik.png" alt="img" class="width_footer_sub_img" /></div>
				</div>
				<div class="col-12 col-md-12 col-lg-4 ">
					<div class="footer_main_title py-3"> Last Modified Posts</div>
					<a href="#" class="footer_img_post_6"><img src="<?= base_url('assets/'); ?>images/allef-vinicius-108153.jpg" alt="img" /></a>
					<a href="#" class="footer_img_post_6"><img src="<?= base_url('assets/'); ?>images/32-450x260.jpg" alt="img" /></a>
					<a href="#" class="footer_img_post_6"><img src="<?= base_url('assets/'); ?>images/download (1).jpg" alt="img" /></a>
					<a href="#" class="footer_img_post_6"><img src="<?= base_url('assets/'); ?>images/science-578x362.jpg" alt="img" /></a>
					<a href="#" class="footer_img_post_6"><img src="<?= base_url('assets/'); ?>images/vil-son-35490.jpg" alt="img" /></a>
					<a href="#" class="footer_img_post_6"><img src="<?= base_url('assets/'); ?>images/zack-minor-15104.jpg" alt="img" /></a>
					<a href="#" class="footer_img_post_6"><img src="<?= base_url('assets/'); ?>images/download.jpg" alt="img" /></a>
					<a href="#" class="footer_img_post_6"><img src="<?= base_url('assets/'); ?>images/download (2).jpg" alt="img" /></a>
					<a href="#" class="footer_img_post_6"><img src="<?= base_url('assets/'); ?>images/ryan-moreno-98837.jpg" alt="img" /></a>
				</div>
			</div>
